        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0">Pentiing akan membimbing dan mengarahkan apa saja yang akan diperlukan sebelum pernikahan, baik mental maupun fisik.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0">Masa emas buah hati berada pada umur dari lahir hingga dua tahun. Jangan sia siakan, dan pastikan berikan yang terbaik bagi si kecil. </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                ...
                <div class="d-block bg-primary h-100 text-center">
                    ...
                    <div class="p-4">
                        <p class="text-white mb-4">
                            Konsultan Renjun merupakan salah satu konsultan terbaik yang ada pada Pentiing. Anda bisa melakukan konsultasi secara langsung dengan Renjun. 
                            Renjun akan membantu memberi bimbingan dan mengarahkan bagaimana menghadapi berbagai situasi. Mulai dari sebelum pernikahan hingga memiliki anak.
                        </p>
